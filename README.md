...
|             SerializeRelatedSiteWithJsonSpanSerializer |    284.5 ns |    11.5200 ns |   0.6509 ns | 0.0510 |     216 B |
...
|           SerializeClosedDetailsWithJsonSpanSerializer |  1,173.1 ns |     6.6566 ns |   0.3761 ns | 0.2155 |     912 B |
...
|                  SerializeNoticeWithJsonSpanSerializer |    500.8 ns |     0.9640 ns |   0.0545 ns | 0.0525 |     224 B |
...
|           SerializeMigrationInfoWithJsonSpanSerializer |  2,480.8 ns |    38.1145 ns |   2.1535 ns | 0.3815 |    1616 B |
...
|              SerializeBadgeCountWithJsonSpanSerializer |    279.5 ns |     0.4503 ns |   0.0254 ns | 0.0339 |     144 B |
...
|                 SerializeStylingWithJsonSpanSerializer |    237.8 ns |    52.6565 ns |   2.9752 ns | 0.0513 |     216 B |
...
|        SerializeOriginalQuestionWithJsonSpanSerializer |    345.5 ns |   288.9455 ns |  16.3260 ns | 0.0548 |     232 B |
|        SerializeOriginalQuestionWithUtf8JsonSerializer |    265.5 ns |    40.4636 ns |   2.2863 ns | 0.0300 |     128 B |
|             SerializeNetworkUserWithJsonSpanSerializer |  1,404.3 ns |     3.4729 ns |   0.1962 ns | 0.1812 |     768 B |
...
|            SerializeNotificationWithJsonSpanSerializer |  2,590.1 ns |    25.5791 ns |   1.4453 ns | 0.4158 |    1752 B |
...
|                    SerializePostWithJsonSpanSerializer |  4,981.9 ns |   150.8151 ns |   8.5213 ns | 0.8011 |    3392 B |
...
|               SerializePrivilegeWithJsonSpanSerializer |    256.8 ns |     0.1511 ns |   0.0085 ns | 0.0453 |     192 B |
...
|                SerializeQuestionWithJsonSpanSerializer | 19,314.3 ns |   338.9127 ns |  19.1492 ns | 3.0212 |   12712 B |
...
|        SerializeQuestionTimelineWithJsonSpanSerializer |  2,114.1 ns |   225.2162 ns |  12.7251 ns | 0.3510 |    1480 B |
...
|              SerializeReputationWithJsonSpanSerializer |    834.7 ns |   112.5561 ns |   6.3596 ns | 0.1020 |     432 B |
...
|       SerializeReputationHistoryWithJsonSpanSerializer |    647.2 ns |     3.3445 ns |   0.1890 ns | 0.0868 |     368 B |
...
|                SerializeRevisionWithJsonSpanSerializer |  1,809.3 ns |     2.8147 ns |   0.1590 ns | 0.3033 |    1280 B |
...
|           SerializeSearchExcerptWithJsonSpanSerializer |  3,483.2 ns |   654.4405 ns |  36.9771 ns | 0.4845 |    2048 B |
...
|             SerializeShallowUserWithJsonSpanSerializer |    746.1 ns |   104.7563 ns |   5.9189 ns | 0.1211 |     512 B |
...
|           SerializeSuggestedEditWithJsonSpanSerializer |  2,027.4 ns |    37.3830 ns |   2.1122 ns | 0.2747 |    1160 B |
...
|                     SerializeTagWithJsonSpanSerializer |    755.6 ns |     5.5355 ns |   0.3128 ns | 0.1040 |     440 B |
...
|                SerializeTagScoreWithJsonSpanSerializer |    885.6 ns |    28.9562 ns |   1.6361 ns | 0.1459 |     616 B |
...
|              SerializeTagSynonymWithJsonSpanSerializer |    853.5 ns |     5.2321 ns |   0.2956 ns | 0.0906 |     384 B |
...
|                 SerializeTagWikiWithJsonSpanSerializer |  2,127.4 ns |    16.8069 ns |   0.9496 ns | 0.3433 |    1448 B |
...
|                  SerializeTopTagWithJsonSpanSerializer |    488.6 ns |    13.3824 ns |   0.7561 ns | 0.0772 |     328 B |
...
|                    SerializeUserWithJsonSpanSerializer |  2,869.9 ns |    44.9765 ns |   2.5413 ns | 0.4349 |    1840 B |
...
|            SerializeUserTimelineWithJsonSpanSerializer |    975.9 ns |     2.2053 ns |   0.1246 ns | 0.1354 |     576 B |
...
|         SerializeWritePermissionWithJsonSpanSerializer |    444.4 ns |     3.2374 ns |   0.1829 ns | 0.0873 |     368 B |
...
|     SerializeMobileBannerAdImageWithJsonSpanSerializer |    274.1 ns |     2.7156 ns |   0.1534 ns | 0.0358 |     152 B |
...
|                    SerializeSiteWithJsonSpanSerializer |  2,051.4 ns |   133.1807 ns |   7.5250 ns | 0.3433 |    1448 B |
|                  SerializeAccessTokenWithJilSerializer |    700.0 ns |     9.1951 ns |   0.5195 ns | 0.2146 |     904 B |
|             SerializeAccessTokenWithJsonSpanSerializer |    623.2 ns |   145.1142 ns |   8.1992 ns | 0.0658 |     280 B |
...
|            SerializeAccountMergeWithJsonSpanSerializer |    513.8 ns |     1.4882 ns |   0.0841 ns | 0.0563 |     240 B |
...
|                  SerializeAnswerWithJsonSpanSerializer |  5,710.1 ns |   137.2463 ns |   7.7547 ns | 0.9003 |    3784 B |
...
|                   SerializeBadgeWithJsonSpanSerializer |  1,111.6 ns |     6.0292 ns |   0.3407 ns | 0.1945 |     824 B |
...
|                 SerializeCommentWithJsonSpanSerializer |  2,184.9 ns | 1,163.4515 ns |  65.7372 ns | 0.3548 |    1504 B |
...
|                   SerializeErrorWithJsonSpanSerializer |    253.6 ns |     1.5375 ns |   0.0869 ns | 0.0396 |     168 B |
...
|                   SerializeEventWithJsonSpanSerializer |    627.1 ns |   100.1936 ns |   5.6611 ns | 0.0753 |     320 B |
...
|              SerializeMobileFeedWithJsonSpanSerializer |  7,515.6 ns |    42.8527 ns |   2.4213 ns | 1.5106 |    6352 B |
...
|          SerializeMobileQuestionWithJsonSpanSerializer |    809.8 ns |     1.3331 ns |   0.0753 ns | 0.1459 |     616 B |
...
|         SerializeMobileRepChangeWithJsonSpanSerializer |    460.7 ns |     3.7398 ns |   0.2113 ns | 0.0701 |     296 B |
...
|         SerializeMobileInboxItemWithJsonSpanSerializer |    785.0 ns |     2.3453 ns |   0.1325 ns | 0.1287 |     544 B |
...
|        SerializeMobileBadgeAwardWithJsonSpanSerializer |    709.0 ns |     1.9159 ns |   0.1082 ns | 0.1154 |     488 B |
...
|         SerializeMobilePrivilegeWithJsonSpanSerializer |    624.6 ns |     4.1370 ns |   0.2337 ns | 0.1154 |     488 B |
...
| SerializeMobileCommunityBulletinWithJsonSpanSerializer |    937.0 ns |   189.1869 ns |  10.6894 ns | 0.1726 |     728 B |
...
|  SerializeMobileAssociationBonusWithJsonSpanSerializer |    370.0 ns |     0.9882 ns |   0.0558 ns | 0.0510 |     216 B |
...
|      SerializeMobileCareersJobAdWithJsonSpanSerializer |    547.9 ns |     5.2270 ns |   0.2953 ns | 0.0811 |     344 B |
...
|          SerializeMobileBannerAdWithJsonSpanSerializer |    558.0 ns |     2.7782 ns |   0.1570 ns | 0.0772 |     328 B |
...
|      SerializeMobileUpdateNoticeWithJsonSpanSerializer |    222.4 ns |     0.7891 ns |   0.0446 ns | 0.0455 |     192 B |
...
|              SerializeFlagOptionWithJsonSpanSerializer |    869.0 ns |   183.8723 ns |  10.3891 ns | 0.1974 |     832 B |
...
|               SerializeInboxItemWithJsonSpanSerializer |  2,835.1 ns |    25.8111 ns |   1.4584 ns | 0.4539 |    1912 B |
...
|                    SerializeInfoWithJsonSpanSerializer |  2,803.1 ns |    14.0772 ns |   0.7954 ns | 0.5112 |    2160 B |
