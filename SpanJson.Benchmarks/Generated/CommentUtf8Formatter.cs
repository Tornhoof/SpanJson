...
namespace SpanJson.Benchmarks.Generated
{
    ...
    {
        private static readonly byte[] _comment_idName = Encoding.UTF8.GetBytes("\"comment_id\":");
        private static readonly byte[] _post_idName = Encoding.UTF8.GetBytes("\"post_id\":");
        private static readonly byte[] _creation_dateName = Encoding.UTF8.GetBytes("\"creation_date\":");
        private static readonly byte[] _post_typeName = Encoding.UTF8.GetBytes("\"post_type\":");
        private static readonly byte[] _scoreName = Encoding.UTF8.GetBytes("\"score\":");
        private static readonly byte[] _editedName = Encoding.UTF8.GetBytes("\"edited\":");
        ...
        private static readonly byte[] _reply_to_userName = Encoding.UTF8.GetBytes("\"reply_to_user\":");
